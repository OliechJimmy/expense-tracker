...
st.write(
    'Upload your past expense data and enter your monthly income to get a personalised spending plan that guarantees at least 5% monthly savings.')
...
if total_monthly_spending > available_for_spending:
    ...
    st.success(f'Great news! Your current spending already allows for at least 5% savings. Here is your recommended monthly budget.')
